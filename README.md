...
| ⏵  `after_setup`                            |  callback executed after initializing kitty-scrollback.nvim (`fun(kitty_data:KsbKittyData,opts:KsbOpts) \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ⏵  `after_launch`                           |  callback executed after launch started to process the scrollback buffer (`fun(kitty_data:KsbKittyData,opts:KsbOpts) \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ⏵  `after_ready`                            |  callback executed after scrollback buffer is loaded and cursor is positioned (`fun(kitty_data:KsbKittyData,opts:KsbOpts) \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| ⏵  `KittyScrollbackNvimNormal`              |  status window Normal highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ⏵  `KittyScrollbackNvimHeart`               |  status window heart icon highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ⏵  `KittyScrollbackNvimSpinner`             |  status window spinner icon highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ⏵  `KittyScrollbackNvimReady`               |  status window ready icon highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ⏵  `KittyScrollbackNvimKitty`               |  status window kitty icon highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ⏵  `KittyScrollbackNvimVim`                 |  status window vim icon highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ⏵  `KittyScrollbackNvimPasteWinNormal`      |  paste window Normal highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ⏵  `KittyScrollbackNvimPasteWinFloatBorder` |  paste window FloatBorder highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ⏵  `KittyScrollbackNvimPasteWinFloatTitle`  |  paste window FloatTitle highlight group (`table \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `status_window`                            |  options for status window indicating that kitty-scrollback.nvim is ready (`KsbStatusWindowOpts \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ⏵  `enabled`                                |  If true, show status window in upper right corner of the screen (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ⏵  `style_simple`                           |  If true, use plaintext instead of nerd font icons (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ⏵  `autoclose`                              |  If true, close the status window after kitty-scrollback.nvim is ready (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ⏵  `show_timer`                             |  If true, show a timer in the status window while kitty-scrollback.nvim is loading (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `paste_window`                             |  options for paste window that sends commands to Kitty (`KsbPasteWindowOpts \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ⏵  `highlight_as_normal_win`                |  If function returns true, use Normal highlight group. If false, use NormalFloat (`fun():boolean \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ⏵  `filetype`                               |  The filetype of the paste window (`string \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ⏵  `hide_footer`                            |  If true, hide the footer when the paste window is initially opened (`boolean \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ⏵  `winblend`                               |  The winblend setting of the window, see :help winblend (`integer \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ⏵  `winopts_overrides`                      |  Paste float window overrides, see nvim_open_win() for configuration (`fun(paste_winopts:KsbWinOpts):table<string,any> \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ⏵  `footer_winopts_overrides`               |  Paste footer window overrides, see nvim_open_win() for configuration (`fun(footer_winopts:KsbWinOpts,paste_winopts:KsbWinOpts):table<string,any> \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `kitty_get_text`                           |  options passed to get-text when reading scrollback buffer, see `kitty @ get-text --help` (`KsbKittyGetText \| nil` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ⏵  `ansi`                                   |  If true, the text will include the ANSI formatting escape codes for colors, bold, italic, etc. (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ⏵  `clear_selection`                        |  If true, clear the selection in the matched window, if any. (`boolean` )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ⏵  `extent`                                 |  What text to get. The default of screen means all text currently on the screen. all means all the screen+scrollback and selection means the currently selected text. first_cmd_output_on_screen means the output of the first command that was run in the window on screen. last_cmd_output means the output of the last command that was run in the window. last_visited_cmd_output means the first command output below the last scrolled position via scroll_to_prompt. last_non_empty_output is the output from the last command run in the window that had some non empty output. The last four require shell_integration to be enabled. Choices: screen, all, first_cmd_output_on_screen, last_cmd_output, last_non_empty_output, last_visited_cmd_output, selection (`string` ) |
