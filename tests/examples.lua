...
require('kitty-scrollback').setup({
  ...
  ksb_example_get_text_all_plain = function()
    return {
      kitty_get_text = {
        extent = 'all',
        ansi = false,
  ...
  ksb_example_get_text_first_cmd_output_on_screen = function()
    return {
      kitty_get_text = {
  ...
  ksb_example_get_text_first_cmd_output_on_screen_plain = function()
    return {
      kitty_get_text = {
        extent = 'first_cmd_output_on_screen',
        ansi = false,
  ...
  ksb_example_get_text_last_cmd_output_plain = function()
    return {
      kitty_get_text = {
  ...
  ksb_example_get_text_last_non_empty_output = function()
    return {
      kitty_get_text = {
  ...
  ksb_example_get_text_last_non_empty_output_plain = function()
    return {
      kitty_get_text = {
        extent = 'last_non_empty_output',
        ansi = false,
  ...
  ksb_example_get_text_last_visited_cmd_output_plain = function()
    return {
      kitty_get_text = {
  ...
  ksb_example_get_text_screen = function()
    return {
      kitty_get_text = {
        extent = 'screen',
        ansi = true,
  ...
  ksb_example_get_text_screen_plain = function()
    return {
      kitty_get_text = {
        extent = 'screen',
        ansi = false,
  ...
  ksb_example_get_text_selection = function()
    return {
      kitty_get_text = {
        extent = 'selection',
        ansi = true,
  ...
  ksb_example_get_text_selection_keep_selection = function()
    return {
      kitty_get_text = {
        extent = 'selection',
        ansi = true,
  ...
  ksb_example_get_text_selection_plain = function()
    return {
      kitty_get_text = {
        extent = 'selection',
        ansi = false,
  ...
  ksb_example_keymaps_disabled = function()
    return {
      keymaps_enabled = false,
    }
  end,
  ksb_example_paste_win_filetype = function()
    return {
      paste_window = {
        filetype = 'markdown',
      },
  ...
  ksb_example_paste_win_hide_mappings = function()
    return {
      paste_window = {
        hide_footer = true,
      },
  ...
  ksb_example_paste_win_highlight_as_float = function()
    return {
      paste_window = {
  ...
  ksb_example_paste_win_register = function()
    return {
      paste_window = {
        yank_register = '*',
      },
  ...
  ksb_example_paste_win_register_disabled = function()
    return {
      paste_window = {
  ...
  ksb_example_paste_win_winblend = function()
    return {
      paste_window = {
        winblend = 50,
      },
  ...
  ksb_example_paste_win_winopts = function()
    return {
      paste_window = {
        winblend = 10,
  ...
  ksb_example_status_win_autoclose = function()
    return {
      status_window = {
        autoclose = true,
      },
  ...
  ksb_example_status_win_disabled = function()
    return {
      status_window = {
        enabled = false,
      },
  ...
  ksb_example_status_win_show_timer = function()
    return {
      status_window = {
        show_timer = true,
      },
  ...
  ksb_example_status_win_vim = function()
    return {
      status_window = {
        icons = {
          nvim = '',
  ...
  ksb_example_status_win_simple = function()
    return {
      status_window = {
        style_simple = true,
      },
